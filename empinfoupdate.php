...
<div class="w3-row-padding w3-margin-top">
		...
		<h2>Update Information</h2>
			<div class="w3-card-2">
		<form action="empinfoupdate.php" method="post">
			
				<div class="w3-container">
					<label><b>Full Name</b></label><br>
					<input type="text" placeholder="Enter Fullname" name="fullname" required><br>
					<label><b>New username</b>(used for login)</label><br>
					...
					<a href="index.php"><button type="button" class="w3-btn w3-blue-gray w3-round-xlarge"><< Back to Login</button></a>
				</div>
		</form>
			</div>
			<br>
			...
			if(isset($_POST['update']))
			{
				...
				if($password==$cpassword)
				{
					...
					if($query_run)
					{
						...
						{
							$query = "UPDATE empdetail SET name='$fullname',username='$username',password='$password',email='$email',mob_no='$mobile' where emp_no='$empno';";
							echo $query;
							$query_run = mysqli_query($con,$query);
							if($query_run)
							{
								...
								header("refresh:0; url=emplogin.php");
							}
							else
							{
