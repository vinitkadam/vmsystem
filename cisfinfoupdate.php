...
<div class="w3-row-padding w3-margin-top">
		...
		<h2>Update Information</h2>
			<div class="w3-card-2">
		<form action="cisfinfoupdate.php" method="post">
			...
			if(isset($_POST['update']))
			{
				...
				if($password==$cpassword)
				{
					...
					if($query_run)
					{
						...
						{
							$query = "UPDATE cisfdetail SET name='$fullname',username='$username',password='$password',email='$email',mob_no='$mobile' where cisf_no='$cisfno';";
							echo $query;
							$query_run = mysqli_query($con,$query);
							if($query_run)
							{
